...
When I compared a sample of model predictions to actual scores, I observed that the predictions where either the same as the actual values or, at most, off-by-one.
